...
โปรแกรมรับชื่อมา
output:
ชื่อจะกลับหลังพร้อมเป็นพิมพ์เล็กทั้งหมด
constraints:
ควรระวังเรื่อง ตัวพิมพ์ใหญ่ในinput โดยใช้.lowerมาช่วย
```
...
1 รับชื่อมา
2 นำชื่อมากลับหลัง
3 เอาชื่อมาทำเป็นพิมพ์เล็กทั้งหมด
...
```text
ตอนแรกไม่ได้อ่านโจทย์ว่าต้องทำให้เป็นพิมพ์เล็ก แผนแรกจึงทำแค่กลับหลัง
ต่อมาเลยรู้ว่าต้องทำเป็นพิมพ์เล็กทั้งหมดด้วย 
```
...
```text
ทำไมเลือก case นี้: เพราะตอนแรกไม่รู้ว่าต้องทำให้ตัวอักษรเป็พิมพ์เล็ก
a = input()
...
```text
ในโจทย์มีพิมพ์เล็กพิมพ์ใหญ่สลับกัน
a = input()
...
```text
ช่วยบอกวิธีทำให้เป็นพิมพ์เล็กทั้งหมด
```

คุณยังทำอะไรด้วยตนเอง

```text
เอาคำสั่งนั้นมาประยุกต์ใช้
```
