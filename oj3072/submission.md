...
```text
รับ input คำศัพท์มา1ค่า
output แสดงสระในสิ่งที่พิมพ์
ต้องทำให้ทุกตัวเป็นพิมพ์เล็กเพื่ือจะตรวจได้ง่ายขึ้น
...
```text
เหมือนกับแผนแรก ใช้.count เพื่อนับจำนวนสระในประโยค
