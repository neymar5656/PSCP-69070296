...
```text
input:รับจำนวนราคาอาหารเครื่องดื่มอย่างเดียว

output:แสดงจำนวนราคาที่ต้องจ่ายเมื่อคิดค่าบริการกับvat7%แล้ว

constraints:ตรงค่าบริการไม่สามารถนำไปคิดเป็น10%ได้เลย เพราะต้องมีขั้นต่ำ50 และไม่เกิน1000
```
...
```text
step1 อ่านจำนวนราคาอาหาร
step2 นำราคาอาหารไปคำนวณค่าบริการเป็น10%ของราคาอาหาร
step3 เช็คว่าเกิน1000หรือน้อยกว่า50หรือไม่ ถ้าเกิน ค่าบริการ=1000 หรือถ้าน้อยกว่า50ให้=50
step4 เอาค่าอาหารกับริการมารวมกันเพื่อหาvat7%
step5 เอาราคามารวมกัน โดยแสดงทศนิยม2ตำแหน่ง
```
...
```text
เหมือนแผนแรก แค่ปรับให้การคำนวณตัวเลขถูกต้อง
```
...
แสดงทศนิยมแล้วแต่ไม่ใช่2ตำแหน่ง
