...
| OJ submission ID, if submitted | 576757 |
| OJ status | Pass |
...
```text
ช่วยให้สังเกตุว่าถ้าคะแนนต่ำสุดเป็นศูนย์ค่าจะติดลบทำให้โปรแกรมผิดพลาด
```
...
```text
ทดสอบในVS code เพื่อยืนยันว่าเมื่อใช้จริงแล้วจะถูกต้อง
```
...
```text
เรียนรู้ว่าการใช้คำสั่งmaxสามารถทำให้เลขที่คำนวณมาไม่ต่ำกว่า0
```
