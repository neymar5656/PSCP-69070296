...
| OJ submission ID, if submitted | 554685 |
| OJ status | Pass |
...
```text
ถามเรื่องคำสั่งที่ทำให้ตัวใหญ่กับทำให้เว้นวรรคหายไป
...
```text
เรียนรู้คำสั่งที่ทำให้ตัวอักษรหน้าสุดเป็นตัวใหญ่คือคำสั่ง capitalize() และคำสั่ง strip() ที่ทำให้เว้นวรรคหายไป
```
